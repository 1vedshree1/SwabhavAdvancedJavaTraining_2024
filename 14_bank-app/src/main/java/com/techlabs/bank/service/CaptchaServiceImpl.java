...
import com.techlabs.bank.entity.CaptchaEntity; 
import com.techlabs.bank.repository.CaptchaRepository; 
...
public class CaptchaServiceImpl implements CaptchaService { 
    ...
    public boolean validateCaptcha(String userInput) { 
        Optional<CaptchaEntity> captchaEntity = captchaRepository.findById(userInput); 
